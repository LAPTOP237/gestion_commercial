                        ...
                        <div class="row mb-4">
                            ...
                            <div class="modal fade" id="AddLigne">
                                <div class="modal-dialog modal-dialog-centered">
                                        ...
                                        <div class="modal-body p-4">
                                            <form name="ligne-form" id="form-ligne">
                                                ...
                                                <div class="row mt-2">
                                                    ...
                                                    <input type="text" name="commande_num" id="commande_num" value="<?= $num_commande ?>" hidden/>
                                    ...
                                    <form method="post" action="<?= base_url('/save-commande') ?>">
                                        <div class="card-body">
                                            <div class="mt-2 row">
                                               <center><h2>Bon de Commande</h2></center>
                                                ...
                                                <div class="col-4 form-group">
                                                    <label for="date_facture" class="col-form-label">Date de la Commande :</label>
                                                    <input class="form-control" type="date" name="date_commande" id="date_commande">
                                                </div>
                                                <div class="col-4 form-group">
                                                    <label for="num_proforma" class="col-form-label">N° Commande :</label>
                                                    <input class="form-control" type="text" name="num_commande" id="num_commande" value="<?= $num_commande ?>">
                                                </div>
                                                
                                                    <input class="form-control" type="hidden" name="proforma_num" id="proforma_num" value=" ">
    ...
    <script type="text/javascript">
        $(document).ready(function() {
            ...
            function show_ligne() {
                $.ajax({
                    type: 'post',
                    url: '<?php echo site_url('/fetch_all_ligne_commande') ?>',
                    async: true,
                    dataType: 'json',
                    success: function(data) {
                        ...
                        for (i = 0; i < data.length; i++) {
                            ...
                            html += '<tr>' +
                                ...
                                '<a href="javascript:void(0);" class="edit" data-id="' + data[i].id_ligne_commande + '" ><i class="fa fa-edit" aria-hidden="true"></i></a>' + ' ' +
                                '<a href="javascript:void(0);" class="delete" data-id="' + data[i].id_ligne_commande + '"><i class="mdi mdi-delete"></i></a>' +
                                '</td>' +
                                '</tr>';
                        }
            ...
            $('#form-ligne').on('submit', function(event) {
                ...
                $.ajax({
                    ...
                    url: "<?php echo base_url('/action_ligne_commande'); ?>",
            ...
            $(document).on('click', '.edit', function() {
                ...
                $.ajax({
                    ...
                    url: "<?php echo base_url('/fetch_single_ligne_commande'); ?>",
            ...
            $(document).on('click', '.delete', function() {
                ...
                if (confirm("Voulez-vous vraiment supprimer ?")) {
                    ...
                    $.ajax({
                        ...
                        url: "<?php echo base_url('/delete_ligne_commande'); ?>",
