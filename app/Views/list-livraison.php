                                    ...
                                    <div class="row">
                                        <div class="col-12 form-group">
                                            <select id="etat" name="etat" class="form-select">
                                                ...
                                                <option value="1">Valider la livraison</option>
                            ...
                            <div class="col-lg-12">
                                <div class="card mb-0  h-100 ">
                                    <div class="table-responsive card-body">
                                        <h4 class="card-title" style="text-align: center;">Liste des Livraisons</h4>
                                                ...
                                                ?>
                                                        <tr>
                                                            ...
                                                            <td><?php if ($row['etat'] == 1) { ?>
                                                                    <a href="#" class="alert alert-success changeStatut" role="alert" data-id=<?= $row['id_livraison'] ?>>
                                                                        Livré
                                                                    </a>
                                                                <?php } elseif ($row['etat'] == 0) { ?>
                                                                    ...
                                                                    <a href="#" class="alert alert-danger changeStatut" role="alert" data-id=<?= $row['id_livraison'] ?>>
                                                                        En attente
                                                                    </a>
                                                                <?php
                                                                } else {
                                                                ?>
                                                                    <a href="#" class="alert alert-warning changeStatut" role="alert" data-id=<?= $row['id_livraison'] ?>>
                                                                        Annulé
                                                                    </a>
                                                                <?php
                                                                }
                                                            ...
                                                            <td><a href="<?= base_url('/pdf-livraison') . $row['id_livraison'] ?>" class="print"><i class="fa fa-print" aria-hidden="true"></i></a>
                                                                <a href="javascript:void(0);" class="edit"><i class="fa fa-edit" aria-hidden="true"></i></a>
                                                                <a href="<?= base_url('/delete-livraison') . $row['id_livraison'] ?>" class="delete"><i class="mdi mdi-delete"></i></a>
                                                            </td>
                                                        </tr>
                                                <?php
                                                    endforeach;
    ...
    <script>
        ...
        $('#form-etat').on('submit', function(event) {
            ...
            $.ajax({
                ...
                url: "<?php echo base_url('/etat-livraison'); ?>",
