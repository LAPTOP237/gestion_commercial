                        ...
                        <div class="row mb-4">
                            ...
                            <div class="modal fade" id="AddLigne">
                                <div class="modal-dialog modal-dialog-centered">
                                                ...
                                                <div class="row">
                                                    <div class="col-12">
                                                        <div class="mb-3">
                                                            ...
                                                            <input class="form-control" placeholder="" type="text" name="conditionnement" id="conditionnement" />
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="row mt-2">
                                                    <div class="col text-end">
                                                    <input type="text" name="livraison_num" id="livraison_num" value="<?= $num_livraison ?>" hidden/>
                                    ...
                                    <form method="post" action="<?= base_url('/save-livraison') ?>">
                                        <div class="card-body">
                                            <div class="mt-2 row">
                                               <center><h2>Bon de Livraison</h2>
                                               <div class="col-3 form-group">
                                                    <label for="num_livraison" class="col-form-label">N° Livraison:</label>
                                                    <input class="form-control" type="text" name="num_livraison" id="num_livraison" value="<?= $num_livraison ?>">
                                                </div></center>
                                                <div class="col-3 form-group">
                                                ...
                                                <div class="col-3 form-group">
                                                    <label for="date_facture" class="col-form-label">Date de la Livraison :</label>
                                                    <input class="form-control" type="date" name="date_livraison" id="date_livraison">
                                                </div>
                                                <div class="col-3 form-group">
                                                    <label for="num_livraison" class="col-form-label">Adresse de Livraison:</label>
                                                    <input class="form-control" type="text" name="adresse_livraison" id="adresse_livraison" value="">
                                                </div>
                                                
                                                <div class="col-3 form-group">
                                                    <label for="commande_num" class="col-form-label"> Ref. bon de commannde :</label>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <th colspan="2">
                                                            <div class="col-6 form-group">
                                                                <input class="form-control" type="number" name="nb_colis" id="nb_colis">
                                                            </div>
                                                        </th>
                                                    </tr>
    ...
    <script type="text/javascript">
        $(document).ready(function() {
            ...
            function show_ligne() {
                $.ajax({
                    type: 'post',
                    url: '<?php echo site_url('/fetch_all_ligne_livraison') ?>',
                    async: true,
                    dataType: 'json',
                    success: function(data) {
                        ...
                        for (i = 0; i < data.length; i++) {
                            total += parseFloat(data[i].quantite);
                            html += '<tr>' +
                                '<td>' + i + '</td>' +
                                '<td>' + data[i].designation + '</td>' +
                                '<td>' + data[i].quantite + '</td>' +
                                '<td>' + data[i].conditionnement + '</td>' +
                                '<td style="text-align:left;">' +
                                '<a href="javascript:void(0);" class="edit" data-id="' + data[i].id_ligne_livraison + '" ><i class="fa fa-edit" aria-hidden="true"></i></a>' + ' ' +
                                '<a href="javascript:void(0);" class="delete" data-id="' + data[i].id_ligne_livraison + '"><i class="mdi mdi-delete"></i></a>' +
                                '</td>' +
                                '</tr>';
                        }
            ...
            $('#form-ligne').on('submit', function(event) {
                ...
                $.ajax({
                    ...
                    url: "<?php echo base_url('/action_ligne_livraison'); ?>",
            ...
            $(document).on('click', '.edit', function() {
                ...
                $.ajax({
                    ...
                    url: "<?php echo base_url('/fetch_single_ligne_livraison'); ?>",
                    ...
                    success: function(data) {
                        ...
                        $('.modal-header').text('Mise à jour de la Ligne');
            ...
            $(document).on('click', '.delete', function() {
                ...
                if (confirm("Voulez-vous vraiment supprimer ?")) {
                    ...
                    $.ajax({
                        ...
                        url: "<?php echo base_url('/delete_ligne_livraison'); ?>",
