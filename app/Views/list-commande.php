                            ...
                            <div class="col-lg-12">
                                <div class="card mb-0  h-100 ">
                                    <div class="table-responsive card-body">
                                        <h4 class="card-title" style="text-align: center;">Liste des Commandes</h4>
                                        ...
                                        <table id="datatable" class="table table-bordered" style="border-collapse: collapse; border-spacing: 0; width: 100%;">
                                            ...
                                            <?php if ($commandes) :
                                                    ...
                                                    <td><?php if ($row['etat'] == 1) { ?>
                                                                    <a href="#" class="alert alert-success changeStatut" role="alert" data-id=<?= $row['id_commande'] ?>>
                                                                        Validé
                                                                    </a>
                                                                <?php } elseif ($row['etat'] == 0) { ?>
                                                                    ...
                                                                    <a href="#" class="alert alert-danger changeStatut" role="alert" data-id=<?= $row['id_commande'] ?>>
                                                                        En attente
                                                                    </a>
                                                                <?php
                                                                } else {
                                                                ?>
                                                                    <a href="#" class="alert alert-warning changeStatut" role="alert" data-id=<?= $row['id_commande'] ?>>
                                                                        Annulé
                                                                    </a>
                                                                <?php
                                                                }
                                                    ...
                                                    <td><a href="<?= base_url('/pdf-commande').$row['id_commande'] ?>" class="print"><i class="fa fa-print" aria-hidden="true"></i></a>
                                                        <a href="javascript:void(0);" class="edit"><i class="fa fa-edit" aria-hidden="true"></i></a>
                                                        <a href="<?= base_url('/delete-commande').$row['id_commande'] ?>" class="delete"><i class="mdi mdi-delete"></i></a>
                                                    </td>
    ...
    <script>
        ...
        $('#form-etat').on('submit', function(event) {
            ...
            $.ajax({
                ...
                url: "<?php echo base_url('/etat-commande'); ?>",
